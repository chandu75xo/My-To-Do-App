# email_service.py — FIXED for production
# Key fix: all emails now sent in background threads so they never
# block the request and cause gunicorn worker timeouts.
...
def _send(msg):
    """Get current app and dispatch email to background thread."""
